# touch-cuboid-centers — one entry point for everything.
#
...
.PHONY: help setup build run cell test lint clean doctor
...
help: ## Show this help
	...
	@echo ""
	@echo "  Settings: CUBOIDS=$(CUBOIDS) SEED=$(SEED) GUI=$(GUI) RVIZ=$(RVIZ)"
	@echo "  For example: make run CUBOIDS=4 SEED=7"
	@echo ""
