...
def _moveit_config() -> MoveItConfigsBuilder:
    ...
    return MoveItConfigsBuilder(
        "assembly_arm", package_name="table_assembly_moveit_config"
...
def generate_launch_description() -> LaunchDescription:
    ...
    cell = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(get_package_share_directory("table_assembly"), "launch", "cell.launch.py")
        ),
        launch_arguments={
